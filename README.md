...
`pricepulse` composes with the 300+ tool Cognis suite — JSON in/out and a shared
OpenAI-compatible `/v1` backbone. See **[INTEROP.md](INTEROP.md)** for the
suite map, composition patterns, and reference stacks.

## Integrations

Forward `pricepulse`'s findings to STIX/MISP/Sigma/Splunk/Elastic/Slack/webhooks via
