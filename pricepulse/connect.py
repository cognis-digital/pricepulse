"""Native cognis-connect emit for pricepulse — forward findings to any platform.

Maps pricepulse's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    pricepulse ... --format json | pricepulse-emit --to stix
    pricepulse-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
